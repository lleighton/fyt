...
var import_react = __toESM(require("react"), 1), import_View = require("./View/index"), import_jsx_runtime = require("react/jsx-runtime");
class UnimplementedView extends import_react.default.Component {
  setNativeProps = () => {
  };
  render() {
    return process.env.NODE_ENV === "development" && console.warn("Unimplemented view"), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_View.View, { ...this.props });
  }
}
