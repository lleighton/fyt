...
var import_NativeAnimatedModule = require("./NativeAnimatedModule"), import_NativeAnimatedTurboModule = require("./NativeAnimatedTurboModule"), import_NativeEventEmitter = require("../EventEmitter/NativeEventEmitter"), import_Platform = require("../Utilities/Platform"), import_ReactNativeFeatureFlags = require("../ReactNative/ReactNativeFeatureFlags"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_RCTDeviceEventEmitter = require("../EventEmitter/RCTDeviceEventEmitter");
...
const NativeAnimatedHelper = {
  ...
  get nativeEventEmitter() {
    return nativeEventEmitter || (nativeEventEmitter = new import_NativeEventEmitter.NativeEventEmitter(
      ...
      import_Platform.Platform.OS !== "ios" ? null : NativeAnimatedModule
    )), nativeEventEmitter;
  }
};
