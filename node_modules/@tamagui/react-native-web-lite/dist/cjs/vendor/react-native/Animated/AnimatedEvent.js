...
var import_AnimatedValue = require("./nodes/AnimatedValue"), import_NativeAnimatedHelper = require("./NativeAnimatedHelper"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_NativeAnimatedHelper2 = require("./NativeAnimatedHelper");
const __DEV__ = process.env.NODE_ENV !== "production";
function attachNativeEvent(viewRef, eventName, argMapping) {
  const eventMappings = [], traverse = (value, path) => {
    if (value instanceof import_AnimatedValue.AnimatedValue)
  ...
  return (0, import_react_native_web_internals.invariant)(
    ...
    detach() {
      viewRef != null && eventMappings.forEach((mapping) => {
        import_NativeAnimatedHelper.NativeAnimatedHelper.API.removeAnimatedEventFromView(
          viewRef,
          eventName,
...
function validateMapping(argMapping, args) {
  const validate = (recMapping, recEvt, key) => {
    ...
    if (typeof recEvt == "number") {
      (0, import_react_native_web_internals.invariant)(
        recMapping instanceof import_AnimatedValue.AnimatedValue,
