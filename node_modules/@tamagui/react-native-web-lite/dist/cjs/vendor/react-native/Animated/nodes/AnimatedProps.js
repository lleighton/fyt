...
var import_AnimatedEvent = require("../AnimatedEvent"), import_AnimatedNode = require("./AnimatedNode"), import_AnimatedStyle = require("./AnimatedStyle"), import_NativeAnimatedHelper = require("../NativeAnimatedHelper"), import_react_native_web_internals = require("@tamagui/react-native-web-internals");
class AnimatedProps extends import_AnimatedNode.AnimatedNode {
  ...
  __connectAnimatedView() {
    ...
    (0, import_react_native_web_internals.invariant)(nativeViewTag != null, "Unable to locate attached view in the native tree"), import_NativeAnimatedHelper.NativeAnimatedHelper.API.connectAnimatedNodeToView(
      this.__getNativeTag(),
      nativeViewTag
    );
  }
  __disconnectAnimatedView() {
    (0, import_react_native_web_internals.invariant)(this.__isNative, 'Expected node to be marked as "native"');
    const nativeViewTag = this._animatedView;
    (0, import_react_native_web_internals.invariant)(nativeViewTag != null, "Unable to locate attached view in the native tree"), import_NativeAnimatedHelper.NativeAnimatedHelper.API.disconnectAnimatedNodeFromView(
      this.__getNativeTag(),
      nativeViewTag
    );
  }
