...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_EmitterSubscription = require("./_EmitterSubscription"), import_EventSubscriptionVendor = require("./_EventSubscriptionVendor"), sparseFilterPredicate = () => !0;
class EventEmitter {
  /**
   * @constructor
   *
  ...
  addListener(eventType, listener, context) {
    return this._subscriber.addSubscription(
      eventType,
      new import_EmitterSubscription.EmitterSubscription(this, this._subscriber, listener, context)
    );
  }
  /**
