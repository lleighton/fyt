...
var import_View = require("../../../View"), import_deepDiffer = require("../deepDiffer"), import_Platform = require("../../../exports/Platform"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), React = __toESM(require("react"), 1), import_VirtualizedList = require("../VirtualizedList"), import_VirtualizeUtils = require("../VirtualizeUtils"), import_memoize_one = __toESM(require("memoize-one"), 1), import_jsx_runtime = require("react/jsx-runtime");
  ...
  _renderer = (ListItemComponent, renderItem, columnWrapperStyle, numColumns, extraData) => {
    const cols = numColumnsOrDefault(numColumns), render = (props) => ListItemComponent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListItemComponent, { ...props }) : renderItem ? renderItem(props) : null, renderProp = (info) => {
      if (cols > 1) {
        ...
        ), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_View.View, { style: [styles.row, columnWrapperStyle], children: item.map((it, kk) => {
