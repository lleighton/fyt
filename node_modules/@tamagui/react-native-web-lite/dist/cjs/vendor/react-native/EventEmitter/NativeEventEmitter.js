...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_RCTDeviceEventEmitter = require("./RCTDeviceEventEmitter");
class NativeEventEmitter {
  _nativeModule;
  constructor(nativeModule) {
    import_react_native_web_internals.Platform.OS === "ios" && ((0, import_react_native_web_internals.invariant)(
      nativeModule != null,
  ...
  removeAllListeners(eventType) {
    ...
    ), this._nativeModule?.removeListeners(this.listenerCount(eventType)), import_RCTDeviceEventEmitter.RCTDeviceEventEmitter.removeAllListeners(eventType);
  }
