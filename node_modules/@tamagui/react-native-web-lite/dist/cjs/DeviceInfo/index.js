...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_Dimensions = require("../Dimensions/index");
const DeviceInfo = {
  Dimensions: {
    get windowPhysicalPixels() {
      const { width, height, fontScale, scale } = import_Dimensions.Dimensions.get("window");
      return {
        width: width * scale,
        height: height * scale,
        scale,
    ...
    get screenPhysicalPixels() {
      const { width, height, fontScale, scale } = import_Dimensions.Dimensions.get("screen");
      return {
        width: width * scale,
        height: height * scale,
        scale,
