...
var import_modality = require("../modality/index"), import_useEvent = require("../useEvent/index"), import_useLayoutEffect = require("../useLayoutEffect/index");
...
function useHover(targetRef, config) {
  const { contain, disabled, onHoverStart, onHoverChange, onHoverUpdate, onHoverEnd } = config, canUsePE = supportsPointerEvent(), addMoveListener = (0, import_useEvent.useEvent)(canUsePE ? "pointermove" : "mousemove", opts), addEnterListener = (0, import_useEvent.useEvent)(canUsePE ? "pointerenter" : "mouseenter", opts), addLeaveListener = (0, import_useEvent.useEvent)(canUsePE ? "pointerleave" : "mouseleave", opts), addLockListener = (0, import_useEvent.useEvent)(lockEventType, opts), addUnlockListener = (0, import_useEvent.useEvent)(unlockEventType, opts);
