...
var import_createEventHandle = require("../createEventHandle/index"), import_useLayoutEffect = require("../useLayoutEffect/index"), import_useStable = require("../useStable/index");
function useEvent(event, options) {
  const targetListeners = (0, import_useStable.useStable)(() => /* @__PURE__ */ new Map()), addListener = (0, import_useStable.useStable)(() => {
