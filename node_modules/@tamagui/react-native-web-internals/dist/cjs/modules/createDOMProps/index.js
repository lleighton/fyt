...
var import_web = require("@tamagui/web"), import_AccessibilityUtil = require("../AccessibilityUtil/index");
...
const stylesFromProps = /* @__PURE__ */ new WeakMap(), createDOMProps = (elementType, props, options) => {
  ...
  const {
    ...
    // Rest
    ...domProps
  } = props, disabled = accessibilityDisabled, role = import_AccessibilityUtil.AccessibilityUtil.propsToAriaRole(props);
