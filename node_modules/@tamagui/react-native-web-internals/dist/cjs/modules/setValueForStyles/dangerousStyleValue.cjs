...
function dangerousStyleValue(name, value, isCustomProperty) {
  ...
  return isEmpty ? "" : !isCustomProperty && typeof value == "number" && value !== 0 && !(import_unitlessNumbers.unitlessNumbers.hasOwnProperty(name) && import_unitlessNumbers.unitlessNumbers[name]) ? value + "px" : ("" + value).trim();
}