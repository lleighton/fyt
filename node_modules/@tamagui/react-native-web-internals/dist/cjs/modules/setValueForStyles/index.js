...
var import_dangerousStyleValue = require("./dangerousStyleValue");
function setValueForStyles(node, styles) {
  const style = node.style;
  for (let styleName in styles) {
    if (!styles.hasOwnProperty(styleName))
      continue;
    const isCustomProperty = styleName.indexOf("--") === 0, styleValue = (0, import_dangerousStyleValue.dangerousStyleValue)(styleName, styles[styleName], isCustomProperty);
