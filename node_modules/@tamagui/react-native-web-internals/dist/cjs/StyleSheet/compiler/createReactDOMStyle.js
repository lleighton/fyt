...
var import_canUseDOM = require("../../modules/canUseDOM"), import_normalizeValueWithProperty = require("./normalizeValueWithProperty");
const emptyObject = {}, supportsCSS3TextDecoration = !import_canUseDOM.canUseDOM || window.CSS != null && window.CSS.supports != null && (window.CSS.supports("text-decoration-line", "none") || window.CSS.supports("-webkit-text-decoration-line", "none")), ignoredProps = {
  elevation: !0,
  overlayColor: !0,
  resizeMode: !0,
  tintColor: !0
  ...
  for (const prop in style) {
    ...
    if (
      ...
      if (prop === "aspectRatio")
        ...
        const value2 = (0, import_normalizeValueWithProperty.normalizeValueWithProperty)(style[prop], prop), longFormProperties = STYLE_SHORT_FORM_EXPANSIONS[prop];
