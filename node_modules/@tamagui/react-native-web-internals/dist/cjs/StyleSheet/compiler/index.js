...
var import_simple_hash = require("@tamagui/simple-hash"), import_createReactDOMStyle = require("./createReactDOMStyle"), import_hyphenateStyleName = require("./hyphenateStyleName"), import_normalizeValueWithProperty = require("./normalizeValueWithProperty");
...
function createDeclarationBlock(style) {
  ...
  return `{${Object.keys(domStyle).map((property) => {
    const value = domStyle[property], prop = (0, import_hyphenateStyleName.hyphenateStyleName)(property);
